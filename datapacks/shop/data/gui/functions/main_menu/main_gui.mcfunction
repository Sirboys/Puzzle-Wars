...
replaceitem entity @a[scores={GUI=0}] enderchest.4 book{HideFlags:1,display:{Name:"{\"text\":\"§a§lInfo\"}",Lore:["§dDrop item for convenient usage"]},"Enchantments":[{"id":"minecraft:protection","lvl":1}]} 1
