...
execute as @s unless entity @s[scores={Frames=23}] run replaceitem entity @s[tag=fr_24] enderchest.7 rose_red{display:{Name:"[\"\",{\"text\":\"Red Desert \",\"italic\":false,\"color\":\"gold\",\"bold\":true},{\"text\":\"§7(Click to select)\"}]","Lore":["§7Built by §aITZJustKirill"]}} 1
...
replaceitem entity @s[tag=fr_24,scores={Frames=23}] enderchest.7 rose_red{"HideFlags":1,display:{Name:"[\"\",{\"text\":\"Red Desert \",\"italic\":false,\"color\":\"gold\",\"bold\":true},{\"text\":\"§7(§aSelected§7)\"}]","Lore":["§7Built by §aITZJustKirill"]},"Enchantments":[{"id":"minecraft:protection","lvl":1}]} 1
