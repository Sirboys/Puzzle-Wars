...
scoreboard players set @a[team=green] wrong 0
scoreboard players set @a[team=gray] wrong 0
scoreboard players set @a[team=yellow] wrong 0
scoreboard players set @a[team=white] wrong 0
